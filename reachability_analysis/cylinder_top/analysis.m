...
data = load('data_cylinder_-0.36_0.56_top.txt');
X = data(:, 1);
Y = data(:, 2);
Z = data(:, 3) + 1;
...
% figure('Name', 'Scatter3: Cylinder top')
% scatter3(X, Y, Z, 100, c, 'filled')
% grid on

figure('Name', 'Scatter: Cylinder top')
...
data = load("data_cylinder_0.36_0.56_top.txt");
X = data(:, 1);
Y = data(:, 2);
Z = data(:, 3) + 1;
...
data = load("data_cylinder_0.3_-0.5_top.txt");
X = data(:, 1);
Y = data(:, 2);
Z = data(:, 3) + 1;
max_value = max(Z);
...
data1 = load("data_cylinder_-0.36_0.56_top.txt");
data2 = load("data_cylinder_0.36_0.56_top.txt");
data3 = load("data_cylinder_0.3_-0.5_top.txt");
X = data(:,1);
Y = data(:,2);
